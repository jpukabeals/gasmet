...
getwd()
list.files("2020_jul-oct_txt-for-jakek")
# note both .txt and .TXT

# easier to set and then reset working directory to folder

# organizing into groups with similar naming systems
